<%@ Page Title="" Language="VB" MasterPageFile="~/Controles/MasterPage.master" AutoEventWireup="false" CodeFile="TiposUnidadList.aspx.vb" Inherits="Webforms_TiposUnidadList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="100%" style="border-right: whitesmoke thin solid; border-top: whitesmoke thin solid; border-left: whitesmoke thin solid; border-bottom: whitesmoke thin solid">
        <tr valign ="top">
        <td style="width: 75%;"> 
            <asp:Label ID="lbl_Titulo" runat="server" Text="VISTA GENERAL DE TIPOS DE UNIDAD" Width="100%" CssClass="TitTitulo" BackColor="PeachPuff"></asp:Label><br />
        ...
        <tr valign ="top">
            <td colspan="2" align="center">
                <telerik:RadGrid ID="Rg_Listado" runat="server"
                    AllowSorting="True" GridLines="None" Skin="Simple" Width="99%" AutoGenerateColumns="False" ShowStatusBar="True" TabIndex="5" PageSize="15">
                    ...
                    <Selecting AllowRowSelect ="True"  />
                     ...
                     <ExportSettings
                       HideStructureColumns="True" filename ="TiposUnidad" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                    </ExportSettings>
    ...
    <telerik:RadAjaxLoadingPanel ID="LoadingPanel2" runat="server" BackgroundPosition="Right"  Transparency="50">

...
Partial Class Webforms_SucursalesList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim ListSucursales As List(Of SucursalesBrl) = Session("ListSucursales")

        'si no hay una variable de sesión con la lista.
        If ListSucursales Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListSucursales = SucursalesBrl.CargarTodos()
            Session("ListSucursales") = ListSucursales
        End If

        Rg_Listado.DataSource = Session("ListSucursales")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Sucursales.aspx?Editar=1&ID=" & item("id").Text)
    End Sub

<%@ Page Title="" Language="VB" MasterPageFile="~/Controles/MasterPage.master" AutoEventWireup="false" CodeFile="Ppto_CuentasList.aspx.vb" Inherits="Webforms_Ppto_CuentasList" %>
        ...
        <tr valign ="top">
            <td colspan="2" align="center">
                <telerik:RadGrid ID="Rg_Listado" runat="server"  AllowSorting="True" 
                    GridLines="None" Skin="Simple" Width="99%" 
                    ...
                    <MasterTableView  NoDetailRecordsText="No hay informaci&#243;n." NoMasterRecordsText="No hay informaci&#243;n." DataKeyNames="Id" 
                        CommandItemDisplay ="Top" PageSize="20">
                        <Columns>
                           <telerik:GridTemplateColumn HeaderText="No." UniqueName="TemplateColumn2" DefaultInsertValue="">
                            ...
                            <telerik:GridBoundColumn DataField="Codigo_Regional" HeaderText="Regional"
                                SortExpression="Codigo_Regional" UniqueName="Codigo_Regional" >
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                                <ItemStyle HorizontalAlign ="Left" />    
                            </telerik:GridBoundColumn> 
                            ...
                            <telerik:GridTemplateColumn HeaderText="Visible" UniqueName="CuentaVisible" DefaultInsertValue="" >
					            <ItemTemplate>
					               <asp:CheckBox runat="server" ID="chk_visible" Checked = '<%# Eval("Visible")%>' Enabled="false" />
					            </ItemTemplate>

...
Partial Class Webforms_Ppto_AjustesList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim ListPpto_Ajustes As List(Of Ppto_AjustesBrl) = Session("ListPpto_Ajustes")

        'si no hay una variable de sesión con la lista.
        If ListPpto_Ajustes Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListPpto_Ajustes = Ppto_AjustesBrl.CargarPorId_Contrato(0)
            Session("ListPpto_Ajustes") = ListPpto_Ajustes
        End If

        Rg_Listado.DataSource = Session("ListPpto_Ajustes")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Ppto_Ajustes.aspx?Refrescar=1&Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        Response.Redirect("../webforms/Ppto_AjustesList.aspx?Refrescar=1")
    End Sub
    ...
    Protected Sub btn_limpiar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_limpiar.Click
        ...
        rdb_Tipo.SelectedValue = Nothing
    ...
    Protected Sub btn_Procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Procesar.Click
        ...
        Dim ListPpto_Ajustes As List(Of Ppto_AjustesBrl)
        ...
        ListPpto_Ajustes = Ppto_AjustesBrl.CargarPorBusqueda(wfechainicio, wfechafinal, rdb_Tipo.SelectedValue, Ddl_Contratos.SelectedValue, ddl_Ordenes.SelectedValue, Session("Id_Proyecto"))
        Session("ListPpto_Ajustes") = ListPpto_Ajustes
        Rg_Listado.DataSource = Session("ListPpto_Ajustes")
        Rg_Listado.DataBind()

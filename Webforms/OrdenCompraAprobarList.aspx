<%@ Page Title="" Language="VB" MasterPageFile="~/Controles/MasterPage.master" AutoEventWireup="false" CodeFile="OrdenCompraAprobarList.aspx.vb" Inherits="Webforms_OrdenCompraAprobarList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="tbl_Interna" border="0" cellpadding="1" cellspacing="0" width="100%" style="border-right: whitesmoke thin solid; border-top: whitesmoke thin solid; border-left: whitesmoke thin solid; border-bottom: whitesmoke thin solid">
        ...
        <td style="width: 25%" align="right">
            <asp:ImageButton ID="btn_aprobar" runat="server" ImageUrl="~/Images/DBActive.jpg" ToolTip="Aprobar Proceso" TabIndex="1" />
            ...
            <td colspan="2" align="center">    
                <asp:Panel ID="pnl_buscar" runat="server" HorizontalAlign="Center" Width="90%" style="text-align: center; border-right: palegoldenrod thin ridge; border-top: palegoldenrod thin ridge; border-left: palegoldenrod thin ridge; border-bottom: palegoldenrod thin ridge;" Visible="False"  >
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; text-align: left">
                        <tr valign="top">
                            ...
                            <td colspan="1">
                                <asp:ImageButton ID="imb_todos" runat="server" ImageAlign="Right" ImageUrl="~/Images/New.jpg"
                                    ToolTip="Limpia Datos de Búsqueda" TabIndex="7" />
                        ...
                        <tr valign="top">
                            <td style="width: 15%">
                                <asp:Label ID="Label6" runat="server" Text="Número" Width="94%"></asp:Label></td>
                            <td style="width: 15%">
                                <asp:TextBox ID="txt_numero" runat="server" Font-Size="X-Small" MaxLength="12" Width="90%" CssClass="Digitar"></asp:TextBox></td>
                            <td style="width: 15%">
                                <asp:Label ID="Label7" runat="server" Text="Fecha Inicial " Width="94%"></asp:Label></td>
                            <td style="width: 15%">
                            ...
                            <td style="width: 15%">
                                <asp:Label ID="Label8" runat="server" Text="Proveedor / Tercero" Width="94%"></asp:Label></td>
                            <td style="width: 15%">
                        ...
                        <tr valign="top">
                            <td style="width: 15%">
                                <asp:Label ID="Label9" runat="server" Text="Regional" Width="94%"></asp:Label></td>
                            <td style="width: 15%">
                                <asp:DropDownList ID="ddl_regional" runat="server" Font-Size="X-Small" CssClass="drop01" TabIndex="1">
                                </asp:DropDownList></td>
                            <td style="width: 15%">
                                <asp:Label ID="Label11" runat="server" Text="Fecha Final" Width="94%"></asp:Label></td>
                            <td style="width: 15%">
                            ...
                            <td style="width: 15%">
                                <asp:Label ID="Label22" runat="server" Text="Producto" Width="94%"></asp:Label>&nbsp;
                            </td>
                            <td style="width: 15%">
		...
		<tr valign="top">
			<td  class="DataGridFormList" colspan="2">
                <telerik:RadGrid ID="Rg_Listado" runat="server" AllowSorting="True" GridLines="None" Skin="Simple" Width="100%" AutoGenerateColumns="False" ShowStatusBar="True" TabIndex="7" PageSize="15" ShowFooter="True">
                    <MasterTableView  NoDetailRecordsText="No hay informaci&#243;n." NoMasterRecordsText="No hay informaci&#243;n." DataKeyNames="Id" CommandItemDisplay ="Top" PageSize="20">
                        <Columns>
                           <telerik:GridTemplateColumn HeaderText="No." UniqueName="TemplateColumn5" DefaultInsertValue="">
                                <ItemTemplate>
                            ...
                            <telerik:GridBoundColumn DataField="Id" DataType="System.Int32" HeaderText="Id" ReadOnly="True"
                                SortExpression="Id" UniqueName="Id"  Display ="False" DefaultInsertValue="">
                            ...
                            <telerik:GridBoundColumn DataField="Terceros.Razon_Social" HeaderText="Razon Social"
                                SortExpression="Terceros.Razon_Social" UniqueName="Terceros.Razon_Social"  Aggregate ="Count" DefaultInsertValue="">
                                <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    Font-Underline="False" HorizontalAlign="Center" Wrap="True" />
                            </telerik:GridBoundColumn>       
					        ...
					        <telerik:GridTemplateColumn HeaderText="ADM" UniqueName="TemplateColumn1" HeaderTooltip="Aprobaci&#243;n Financiera">
			                    <ItemTemplate>
					        ...
					        <telerik:GridTemplateColumn HeaderText="COO" UniqueName="TemplateColumn2" HeaderTooltip="Aprobaci&#243;n Coordinador Regional" >
			                    <ItemTemplate>
					        ...
					        <telerik:GridTemplateColumn HeaderText="OPE" UniqueName="TemplateColumn3" HeaderTooltip="Aprobaci&#243;n Dir. Operaciones" >
			                    <ItemTemplate>
                    ...
                    <Selecting AllowRowSelect ="True"  />
                     ...
                     <ExportSettings
                       HideStructureColumns="True" filename ="OrdenCompraAprobar" ExportOnlyData="True" IgnorePaging="True" OpenInNewWindow="True">
                    </ExportSettings>

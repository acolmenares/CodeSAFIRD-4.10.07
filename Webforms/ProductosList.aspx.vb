...
Partial Class Webforms_ProductosList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim ListProductos As List(Of SubTablasBrl) = Session("ListProductos")

        'si no hay una variable de sesión con la lista.
        If ListProductos Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListProductos = SubTablasBrl.CargarPorId_Tabla(32)
            Session("ListProductos") = ListProductos
        End If

        Rg_Listado.DataSource = Session("ListProductos")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Productos.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        Response.Redirect("../webforms/ProductosList.aspx?Refrescar=1")
    End Sub

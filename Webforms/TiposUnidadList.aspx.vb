...
Partial Class Webforms_TiposUnidadList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim ListTipos_Unidad As List(Of SubTablasBrl) = Session("ListTipos_Unidad")

        'si no hay una variable de sesión con la lista.
        If ListTipos_Unidad Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListTipos_Unidad = SubTablasBrl.CargarPorId_Tabla(83)
            Session("ListTipos_Unidad") = ListTipos_Unidad
        End If

        Rg_Listado.DataSource = Session("ListTipos_Unidad")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("TiposUnidad.aspx?Editar=1&ID=" & item("id").Text)
    End Sub

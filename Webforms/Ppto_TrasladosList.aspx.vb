...
Partial Class Webforms_Ppto_TrasladosList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim ListPpto_Traslados As List(Of Ppto_TrasladosBrl) = Session("ListPpto_Traslados")

        'si no hay una variable de sesión con la lista.
        If ListPpto_Traslados Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListPpto_Traslados = Ppto_TrasladosBrl.CargarPorId_Nivel_Sale(0)
            Session("ListPpto_Traslados") = ListPpto_Traslados
        End If

        Rg_Listado.DataSource = Session("ListPpto_Traslados")
        Rg_Listado.DataBind()
    ...
    Protected Sub Rg_Listado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Rg_Listado.SelectedIndexChanged
        ...
        Response.Redirect("Ppto_Traslados.aspx?Editar=1&ID=" & item("id").Text)
    End Sub
    ...
    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        Response.Redirect("../webforms/Ppto_TrasladosList.aspx?Refrescar=1")
    End Sub
    ...
    Protected Sub btn_Procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Procesar.Click
        ...
        Dim ListPpto_Traslados As List(Of Ppto_TrasladosBrl)
        ...
        ListPpto_Traslados = Ppto_TrasladosBrl.CargarPorBusqueda(wfechainicio, wfechafinal, wnode, Session("Id_Proyecto"))
        Session("ListPpto_Traslados") = ListPpto_Traslados
        Rg_Listado.DataSource = Session("ListPpto_Traslados")
        Rg_Listado.DataBind()

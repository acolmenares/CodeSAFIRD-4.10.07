<%@ Page Title="" Language="VB" MasterPageFile="~/Controles/MasterPage.master" AutoEventWireup="false" CodeFile="Productos.aspx.vb" Inherits="Productos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table id="TablaContenido" cellspacing="0" cellpadding="0" border="0" class="ContentTable" style="width: 100%">
        <tr valign="top">
        <td style="width: 75%"> 
            <asp:Label ID="lbl_Titulo" runat="server" Text="CREACION / MODIFICACION DE PRODUCTOS" Width="90%" CssClass="TitTitulo" BackColor="PeachPuff"></asp:Label><br />
        ...
        <tr valign="top">
            <td>
                <table id="tblContenido" class="EditControlsTable" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
                    ...
                    <tr valign="top">
                        <td  class="LabelCell" style="width: 30%">
                            <asp:Label id="lblNumero" runat="server" Width="90%">Nombre del Producto o Servicio</asp:Label>
                        </td>
                        <td class="ControlCell" style="width: 70%">
                            ...
                            <asp:RequiredFieldValidator ID="rfv_Nombre" runat="server" ControlToValidate="txtNombre"
                                EnableClientScript="False" ErrorMessage="Falta el Nombre de Tipo de Unidad" ValidationGroup="PROD">*</asp:RequiredFieldValidator>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="btnGuardar">
                <UpdatedControls>
                    ...
                    <telerik:AjaxUpdatedControl ControlID="lblMensaje" />
                    <telerik:AjaxUpdatedControl ControlID="txtNombre" />
                    <telerik:AjaxUpdatedControl ControlID="rfv_Nombre" />
                </UpdatedControls>
            </telerik:AjaxSetting>

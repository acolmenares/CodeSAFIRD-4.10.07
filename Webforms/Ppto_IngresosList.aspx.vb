...
Partial Class Webforms_Ppto_IngresosList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim ListPpto_Ingresos As List(Of Ppto_IngresosBrl) = Session("ListPpto_Ingresos")

        'si no hay una variable de sesión con la lista.
        If ListPpto_Ingresos Is Nothing Or Request.QueryString.Item("Refrescar") = 1 Then
            ListPpto_Ingresos = Ppto_IngresosBrl.CargarTodos(Session("Id_Proyecto"))
            Session("ListPpto_Ingresos") = ListPpto_Ingresos
        End If

        Rg_Listado.DataSource = Session("ListPpto_Ingresos")
        Rg_Listado.DataBind()
    ...
    Protected Sub btn_actualizar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_actualizar.Click
        Response.Redirect("../webforms/Ppto_IngresosList.aspx?Refrescar=1")
    End Sub
    ...
    Protected Sub btn_Procesar_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btn_Procesar.Click
        ...
        Dim ListPpto_Ingresos As List(Of Ppto_IngresosBrl)
        ...
        ListPpto_Ingresos = Ppto_IngresosBrl.CargarPorBusqueda(wfechainicio, wfechafinal, txt_nombre.Text, Session("Id_Proyecto"))
        Session("ListPpto_Ingresos") = ListPpto_Ingresos
